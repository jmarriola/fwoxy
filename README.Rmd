...
First, set the initial concentration of oxygen in the water column (**oxy_ic**). Next, set the parameters of the light efficiency (**a_param**) and ecosystem respiration (**er_param**). Equilibrium values for **oxy_ic**, **a_param**, and **er_param** are 250 (mmol/m^3^), 0.2 ((mmol/m^3^)/day)/(W/m^2^)), and 20 (mmol/m^3^/day), respectively.  
```{r, eval = F}
